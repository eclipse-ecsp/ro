...
/**
 * test class for DefaultNotificationIdentifier.
 */
...
public class DefaultNotificationIdentifierTest extends CommonTestBase {
    ...
    /**
     * TDD case 1:
     * When send remote door UNLOCKED request, then
     * V2C API response: NOT_AUTHORIZED, the notification identifier should be
     * REMOTEOPERATIONDOORS_UNLOCKED_NOT_AUTHORIZED.
     */
    ...
    public void getIdentifierNOT_AUTHORIZED() {
        ...
        String result = defaultNotificationIdentifier
    ...
    /**
     * TDD case 2:
     * When send remote door UNLOCKED request, then V2C
     * API response: SUCCESS, the notification identifier should be
     * REMOTEOPERATIONDOORS_UNLOCKED_SUCCESS.
     */

    @Test
    public void getIdentifierSUCCESS() {

        RemoteOperationResponseV1_1 roResponse = new RemoteOperationResponseV1_1();
        roResponse.setResponse(RemoteOperationResponseV1_1.Response.SUCCESS);
        String result = defaultNotificationIdentifier
                .getIdentifier(roResponse, "UNLOCKED", "REMOTEOPERATIONDOORS");
        Assert.assertEquals("REMOTEOPERATIONDOORS_UNLOCKED_SUCCESS", result);
    }
