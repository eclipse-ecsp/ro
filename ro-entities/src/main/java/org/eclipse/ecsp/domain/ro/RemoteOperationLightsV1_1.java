...
/**
 * Version 1_1 event representation for RemoteOperationLights event.
 */
@EventMapping(id = Constants.REMOTEOPERATIONLIGHTS, version = Version.V1_1)
public class RemoteOperationLightsV1_1 extends AbstractRoEventData {
    ...
    public String toString() {
        return "RemoteOperationLightsV1_1 ["
                + "state=" + state
                + ", duration=" + duration
