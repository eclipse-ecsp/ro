...
/**
 * RO Doors version 1_1 event representation.
 */
@EventMapping(id = Constants.REMOTEOPERATIONDOORS, version = Version.V1_1)
public class RemoteOperationDoorsV1_1 extends AbstractRoEventData {

    private static final long serialVersionUID = -729461127188934928L;
    private State state;
    ...
    public String toString() {
        return "RemoteOperationDoorsV1_1 [state=" + state + ", roRequestId=" + roRequestId + "]";
    }
