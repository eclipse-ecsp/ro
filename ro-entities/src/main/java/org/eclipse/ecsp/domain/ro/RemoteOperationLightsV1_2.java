...
/**
 * Version 1_2 event representation for RemoteOperationLights event.
 */
@EventMapping(id = Constants.REMOTEOPERATIONLIGHTSONLY, version = Version.V1_2)
public class RemoteOperationLightsV1_2 extends AbstractRoEventData {

    private static final long serialVersionUID = -179780200695510777L;
    private State state;
    ...
    public String toString() {
        return "RemoteOperationLightsV1_2 ["
                + "state=" + state
                + ", duration=" + duration
