...
/**
 * Version 1_1 event representation for RemoteOperationLiftgate event.
 */
@EventMapping(id = Constants.REMOTEOPERATIONLIFTGATE, version = Version.V1_1)
public class RemoteOperationLiftgateV1_1 extends AbstractRoEventData {

    private static final long serialVersionUID = 2033463435760944315L;
    private State state;
    ...
    public String toString() {
        return "RemoteOperationLiftgateV1_1 [state=" + state + ", roRequestId=" + roRequestId + "]";
    }
