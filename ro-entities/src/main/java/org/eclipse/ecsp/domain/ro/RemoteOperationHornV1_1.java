...
/**
 * Version 1_1 event representation for RemoteOperationHorn event.
 */
@EventMapping(id = Constants.REMOTEOPERATIONHORN, version = Version.V1_1)
public class RemoteOperationHornV1_1 extends AbstractRoEventData {

    private static final long serialVersionUID = -2202116545701884646L;
    private State state;
    ...
    public String toString() {
        return "RemoteOperationHornV1_1 ["
                + "state=" + state
                + ", duration=" + duration
