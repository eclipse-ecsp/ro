...
/**
 * Version 2_0 event representation for RemoteOperationGloveBox event.
 */
@EventMapping(id = Constants.REMOTEOPERATIONGLOVEBOX, version = Version.V2_0)
public class RemoteOperationGloveBoxV2_0 extends AbstractRoEventData {

    private static final long serialVersionUID = 2237910497493529068L;
    private State state;
    ...
    public String toString() {
        return "RemoteOperationGloveBoxV2_0{" + "state=" + state + ", roRequestId='" + roRequestId + '\'' + '}';
    }
