...
/**
 * Version 2_0 event representation for RemoteOperationTrunk event.
 */
@EventMapping(id = Constants.REMOTEOPERATIONTRUNK, version = Version.V2_0)
public class RemoteOperationTrunkV2_0 extends AbstractRoEventData {
    ...
    public String toString() {
        return "RemoteOperationTrunkV2_0 [state=" + state + ", roRequestId=" + roRequestId + "]";
    }
