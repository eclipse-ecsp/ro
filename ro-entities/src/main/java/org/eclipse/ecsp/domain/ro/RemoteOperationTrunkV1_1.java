...
/**
 * Version 1_1 event representation for RemoteOperationTrunk event.
 */
@EventMapping(id = Constants.REMOTEOPERATIONTRUNK, version = Version.V1_1)
public class RemoteOperationTrunkV1_1 extends AbstractRoEventData {
    ...
    public String toString() {
        return "RemoteOperationTrunkV1_1 [state=" + state + ", roRequestId=" + roRequestId + "]";
    }
