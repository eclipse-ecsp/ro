...
/**
 * RO Driver Door event version 1_1 representation.
 */
@EventMapping(id = Constants.REMOTEOPERATIONDRIVERDOOR, version = Version.V1_1)
public class RemoteOperationDriverDoorV1_1 extends AbstractRoEventData {

    private static final long serialVersionUID = -3115679040867131786L;
    private State state;
    ...
    public String toString() {
        return "RemoteOperationDriverDoorV1_1 [state=" + state + ", roRequestId=" + roRequestId + "]";
    }
