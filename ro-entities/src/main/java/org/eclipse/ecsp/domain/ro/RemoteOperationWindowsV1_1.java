...
/**
 * Version 1_1 event representation for RemoteOperationWindows event.
 */
@EventMapping(id = Constants.REMOTEOPERATIONWINDOWS, version = Version.V1_1)
public class RemoteOperationWindowsV1_1 extends AbstractRoEventData {

    private static final long serialVersionUID = -4076577786336751759L;
    private State state;
    ...
    public String toString() {
        return "RemoteOperationWindowsV1_1 ["
                + "state=" + state
                + ", percent=" + percent
                + ", duration=" + duration
