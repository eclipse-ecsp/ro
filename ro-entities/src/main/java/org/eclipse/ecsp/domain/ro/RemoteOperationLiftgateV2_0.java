...
/**
 * Version 2_0 event representation for RemoteOperationLiftgate event.
 */
@EventMapping(id = Constants.REMOTEOPERATIONLIFTGATE, version = Version.V2_0)
public class RemoteOperationLiftgateV2_0 extends AbstractRoEventData {
    ...
    public String toString() {
        return "RemoteOperationLiftgateV2_0 [state=" + state + ", roRequestId=" + roRequestId + "]";
    }
