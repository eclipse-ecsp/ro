...
import static org.eclipse.ecsp.platform.services.ro.constant.EventIdConstants.VEHICLE_ARCH_TYPE;

/**
 * {@link DeviceMessageFailuresEventFiler} filter class for Device message failure event.
 * implements interface {@link ROEventFilter}.
 */
public class DeviceMessageFailuresEventFiler implements ROEventFilter {
    ...
    static {
        ...
        filters.put(EventAttribute.EVENT_FILTER,
                SimpleBeanPropertyFilter.serializeAllExcept(
                        ...
                        Constants.DEVICE_MESSAGE_FAILURES));
        ...
        filters.put(EventAttribute.RO_RESPONSE_FILTER,
                SimpleBeanPropertyFilter.serializeAllExcept(
                        ...
                        VEHICLE_ARCH_TYPE.getValue(),
                        Constants.RO_SCHEDULE_ID,
                        Constants.RO_FILTER_SCHEDULEKEY,
