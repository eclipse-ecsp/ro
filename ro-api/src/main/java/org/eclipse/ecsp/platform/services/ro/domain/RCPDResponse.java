...
/**
 * {@link RCPDResponse} response object for RCPD response..
 */
@Setter
@Getter
...
public class RCPDResponse {
    ...
    public RCPDResponse(String message) {
        this.message = message;
    }

    public RCPDResponse(String message, String rcpdRequestId) {
        this.message = message;
